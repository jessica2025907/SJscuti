...
import RrhhOptimizationArticle from './pages/RrhhOptimizationArticle';
import ContabilidadStartupsArticle from './pages/ContabilidadStartupsArticle';
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/constitucion-sociedades-article" element={<ConstitucionSociedadesArticle onOpenContractModal={handleOpenContractModal} />} />
          ...
          <Route path="/acerca" element={<AcercaDe onOpenContractModal={handleOpenContractModal} />} />
          <Route path="/blog" element={<Blog />} />
          <Route path="/blog/articulos" element={<Articles />} />
          <Route path="/blog/rrhh" element={<RrhhArticles onOpenContractModal={handleOpenContractModal} />} />
          <Route path="/blog/contabilidad" element={<ContabilidadArticles onOpenContractModal={handleOpenContractModal} />} />
          <Route path="/contacto" element={<Contact onOpenContractModal={handleOpenContractModal} />} />
          <Route path="/politicas-privacidad" element={<PoliticasPrivacidad />} />
          <Route path="/terminos-condiciones" element={<TerminosCondiciones />} />
          <Route path="/secretaria" element={<Secretaria onOpenContractModal={handleOpenContractModal} />} />
          ...
          <Route path="/blog/rrhh/optimizar-gestion" element={<RrhhOptimizationArticle onOpenContractModal={handleOpenContractModal} />} />
          <Route path="/blog/contabilidad/guia-startups" element={<ContabilidadStartupsArticle onOpenContractModal={handleOpenContractModal} />} />
        </Routes>
      </BrowserRouter>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <form action="https://formspree.io/f/mrblwolq" method="POST" className="space-y-4">
                ...
                <input
                  type="hidden"
                  name="Servicios_Interesados"
                  value={contractFormData.services.join(', ') || 'Ninguno seleccionado'}
                />
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm">Hemos recibido tu mensaje y te contactaremos a la brevedad.</p>
              </div>
            </div>
            <button
