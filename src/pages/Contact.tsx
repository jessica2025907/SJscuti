...
function Contact({ onOpenContractModal }: ContactProps = {}) {
  return (
      ...
      <div className="flex-grow pt-20">
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="flex justify-center space-x-16 mb-16">
            <a 
              href="https://wa.me/56977063509" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer hover:bg-blue-50"
            >
              <Phone className="w-12 h-12 text-blue-600 mr-4" />
              <span className="text-xl font-medium">+569 770 63 509</span>
            </a>
            <a 
              href="mailto:contacto@sjscuti.cl" 
              className="flex items-center bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer hover:bg-blue-50"
            >
