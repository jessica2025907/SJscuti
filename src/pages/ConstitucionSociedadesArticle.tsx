...
interface ConstitucionSociedadesArticleProps {
  onOpenContractModal?: () => void;
}

function ConstitucionSociedadesArticle({ onOpenContractModal }: ConstitucionSociedadesArticleProps = {}) {
              ...
              {expanded ? (
                <div className="text-gray-700 space-y-6">
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200 text-center">
                    <p className="text-gray-700 text-lg mb-4">¿Necesitas ayuda para constituir una sociedad?</p>
                    <button
